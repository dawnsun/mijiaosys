...
(
   ...
   control_id           bigint(20) not null comment '权限主键',
...
(
   ...
   is_delete            tinyint(1) comment '0-有效 1-删除',
   primary key (id)
);
...
(
   ...
   methed_id            bigint(20) not null comment '操作主键',
   gmt_create           datetime not null comment '创建时间',
   gmt_modified         datetime not null comment '修改时间',
   creator              varchar(32) not null comment '创建人',
   modifier             varchar(32) not null comment '修改人',
...
alter table MENU_MEHTED_RELATION comment '菜单操作关系表';
...
alter table RES_MENU comment '资源菜单表';
...
(
   ...
   methed_icon          varchar(32) comment '操作图标',
...
alter table RES_METHED comment '资源操作表';
...
(
   ...
   control_url          varchar(4000) not null comment '权限URL',
   gmt_create           datetime not null comment '创建时间',
   gmt_modified         datetime not null comment '修改时间',
   creator              varchar(32) not null comment '创建人',
   modifier             varchar(32) not null comment '修改人',
...
alter table ROLE_RES_RELATION comment '角色资源关系表';
...
(
   id                   bigint(20) not null auto_increment,
   sys_id               bigint(20) not null comment '系统主键',
   role_id              bigint(20) not null comment '角色主键',
   gmt_create           datetime not null comment '创建时间',
   gmt_modified         datetime not null comment '修改时间',
   creator              varchar(32) not null comment '创建人',
